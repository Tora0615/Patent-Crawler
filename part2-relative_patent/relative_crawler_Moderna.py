...
MIN = current_running = 1 # MODERNA : 1 ~ 145
MAX = 145
fileName = 'MODERNA'+str(MIN)+'-'+str(MAX)+'.xlsx'
excel_current = 0
...
while True:
    url = host + "/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r="+str(current_running)+"&f=G&l=50&d=PTXT&p=1&S1=%22MODERNA%22&OS=%22MODERNA%22&RS=%22MODERNA%22"
